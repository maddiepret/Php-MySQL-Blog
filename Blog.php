    ...
    <div class="container">
        <div class="row mt-4">
            ...
            <div class="col-sm-8">
                ...
                <h1 class="lead">The Complete blog by using PHP by Maddie Pretorius</h1>
                <?php
                echo ErrorMessage();
                echo SuccessMessage();
                ?>
                ...
                ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <span style="float: right" class="badge-dark text-light px-3">Comments: <?php echo ApproveCommentsAccordingtoPost($PostId); ?>
                            </span>
                            <hr>
                            <p class="card-text">
                                <?php
